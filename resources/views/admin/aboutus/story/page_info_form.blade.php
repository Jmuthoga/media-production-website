...
@section('title', 'Our Story & Mission Page Info')

@section('content')
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3">{{ $pageInfo ? 'Edit' : 'Create' }} Page Info</h1>
        <a href="{{ route('admin.aboutus.story.index') }}" class="btn btn-outline-secondary">Back to Items</a>
    </div>

    <div class="card shadow-sm">
        <div class="card-body">
            <form action="{{ route('admin.aboutus.story.page_info.save') }}" method="POST">
                @csrf
                ...
                @php
                    $stats = $pageInfo?->meta['stats'] ?? [
                        ['title'=>'Client Reviews','value'=>0],
                        ['title'=>'Support Team & Staff','value'=>0],
