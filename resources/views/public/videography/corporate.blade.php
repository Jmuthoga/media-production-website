...
@section('content')
<!--
  Corporate & Event Videography Page
  - Charcoal & Electric Blue Theme
  - Professional, sleek corporate aesthetic
  - Same structure & responsiveness as photography page
-->
    ...
    (function() {
        ...
        function checkStart() {
            ...
            if (rect.top < window.innerHeight) {
                started = true;
                counters.forEach(c => animateValue(document.getElementById(c.id), 0, c.target, duration));
            }
        }
